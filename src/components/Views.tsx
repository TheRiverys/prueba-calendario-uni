...
export const Views: React.FC<ViewsProps> = ({ activeView, schedule }) => {
  const { openModal, deleteDelivery, toggleCompleted, subjects } = useDeliveriesContext();
  const { selectedSubject, setSelectedSubject, sortBy, setSortBy, setActiveView } =
      ...
      case 'calendar':
        return (
          <div className='w-full'>
            ...
            <div className='pt-6'>{renderCalendarView()}</div>
          </div>
        );
      case 'gantt':
        return (
          <div className='w-full'>
            ...
            <div className='pt-6'>{renderGanttView()}</div>
          </div>
        );
      default:
        return null;
