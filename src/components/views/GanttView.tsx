...
import { BarChart3, Calendar, Clock, ChevronLeft, ChevronRight, AlertTriangle } from "lucide-react"
import { format, parseISO, startOfMonth, endOfMonth, eachDayOfInterval, isSameDay, addMonths, subMonths, addDays, subDays } from "date-fns"
      ...
      <div className="p-6">
        <div className="flex">
          ...
          <ScrollArea className="flex-1">
            <div className="relative" style={{ minWidth: `${timelineWidth}px` }} ref={scrollContainerRef}>
        ...
        <div className="mt-6 pt-4 border-t border-border space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center justify-between p-3 rounded-lg bg-card border border-border shadow-sm">
              ...
              <p className="text-2xl font-bold text-card-foreground tabular-nums">{schedule.length}</p>
            </div>
            <div className="flex items-center justify-between p-3 rounded-lg bg-card border border-border shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-card-foreground">Días totales de estudio</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-card border border-border shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-card-foreground">Promedio días/entrega</span>
              </div>
              <p className="text-2xl font-bold text-card-foreground tabular-nums">
                {schedule.length > 0
